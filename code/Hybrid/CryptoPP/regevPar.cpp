...
compile: g++ regevPar.cpp -pthread -lsodium -lcryptopp -std=c++14 ../../RandomOracle/randomNumberGeneration.cpp ../../Matrix/Matrix.cpp ../../AESHelper/AESHelper.cpp ../../FileHelper/FileHelper.cpp -o 388
...
int main(int argc, char const *argv[])
{
    ...
    {   
        ...
        cout << "Key Genaration time = " << tot/count << " s" << endl;
    }
    else if (option == 2)
    {   
        double tot = 0;
        ...
        cout << "Encryption time = " << tot/count << " s" << endl;
    }
    else if (option == 3)
    {
        ...
        cout << "Decryption time = " << tot/count << " s" << endl;
    }
    else
    {
