...
int main(int argc, char const *argv[])
{
    ...
    cout<<"cipher : "<<endl;
    encoder.Put(cipher.buff,sizeof(cipher.buff));
    encoder.MessageEnd();
    cout<<endl;
    cout<<"Generating "<<m*n<<" integers Operation took: "<<time_span.count()<<" seconds !!!"<<endl;
    cout<<"_____________"<<endl;
